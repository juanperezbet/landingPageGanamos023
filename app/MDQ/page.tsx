...
const WELCOME_BONUS2 = config.welcomeBonuses2.MDQ
const MINIMUM_DEPOSIT = config.minimumDeposits.MDQ
const MINIMUM_RETIRO = config.minimumRetiro.MDQ
const LOCATION_NAME = config.locationNames.MDQ
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-start px-4 py-8 text-center">
        ...
        <div className="w-full max-w-4xl mx-auto mb-8">
          ...
          <div className="mb-6 relative">
            ...
            <div className="relative">
              <Image
                ...
                alt="GANAMOS.BIZ Logo" //ESTA TAMBIEN CAMBIAR
                width={400}
                height={120}
          ...
          <div className="mb-6 bg-gradient-to-r from-amber-700 to-amber-600 rounded-lg p-3 transform rotate-[-1deg] shadow-lg animate-shimmer">
            ...
            <div className="flex items-center justify-center gap-2">
              <p className="text-xl font-bold text-white">
                Si es superior a 10.000: <span className="text-2xl">{WELCOME_BONUS2}</span>
              </p>
            </div>*/}
          </div>
